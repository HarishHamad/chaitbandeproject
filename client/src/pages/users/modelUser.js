...
import { useCreate, useForm, useShow } from "@refinedev/core";


const ModelUser = ({ isModalOpen, setIsModalOpen,parent_id }) => {
    ...
    try {
      mutate({
        ...
        values:{
         ...
         divyangdescription: values?.divyangdescription
  ...
  //   } else {
  //     const preview = await file.preview();
  //     window.open(preview);
  //   }
  // };
    ...
    <>
      ...
      >
          ...
          <Form {...formProps} layout="vertical" onFinish={handleFormFinish}>
            ...
            <Form.Item style={{marginLeft:"1055px"}}>
