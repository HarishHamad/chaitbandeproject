...
import { AuthPage, ErrorComponent, notificationProvider, ThemedLayoutV2 } from "@refinedev/antd";
import {
...
const App = () => {
    ...
    const authProvider = {
        ...
        getIdentity: async () => {
            ...
            const { data, status } = await strapiAuthHelper.me(token, { metaData: { populate: ['photo', 'role'] } });
            if (status === 200) {
